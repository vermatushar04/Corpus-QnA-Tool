...
private:
    ...
    void query_llm(string filename, Node* root, int k, string API_KEY, string question, string outFile);
...
public:
    ...
    Node* get_top_k_para_modified(string question,int k);
